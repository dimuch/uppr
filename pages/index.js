...
const howItWorks = [
  {
    ...
    content:
      'Відчуй на собі ефективність гнучкого Agile-принципу, який допомагає як в розробці програмного забезпечення, ' +
      'так і у навчанні. Готовий до змін та самовдосконалення? Тоді цей курс для Тебе!',
  },
  {
    icon: 'icon-settings-1',
    content:
      'Кожен модудь поділений на 5 етапів-ітерацій та передбачає проведення стендап-мітингів та ретроспективи.Це дає ' +
      "змогу отримати зворотній зв'язок та одразу вносити корективи у процес навчання.",
  },
  {
    icon: 'icon-thumb-icon',
    content:
      "Ніхто не стоїть над тобою з указкою та не нав'язує нудні вправи.Ти самостійно обираєш домашнє завдання і " +
      'працюєш в комфортному для тебе режимі.',
  },
];
