  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={'https://uppr.com.ua' + downloadData?.downloadLink}
        />
        <meta
          property="og:type"
          content="website"
        ...
        <meta
          property="og:title"
          content={downloadData?.caption + '| UPPR Downloads'}
        />
        <meta
        ...
        <meta
          property="og:image"
          content={'https://uppr.com.ua' + downloadData?.image}
        />
        <meta
        ...
        <link
          rel="image_src"
          href={'https://uppr.com.ua' + downloadData?.image}
        />
