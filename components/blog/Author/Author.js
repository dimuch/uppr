...
const EMAIL_LINK = `
  https://mail.google.com/mail/?view=cm&fs=1&to=ivanka.tabachuk@gmail.com.com&su=Lets communicate&body=Hi%0AI
  have a question
`;
...
export default function Author({ data }) {
 ...
 src: '/assets/images/others/ivanka.jpg', width: 110 
        ...
        <div className={styles.authorDescription}>
          <p className={styles.authorName}>Іванка Табачук</p>
          <p>
            Допомагаю налагодити комунікацію в команді та з замовником, влаштуватися на класну роботу та бути більш
            ефективним у бізнес-середовищі!
          </p>
          <p>
