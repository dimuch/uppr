...
export default function Downloads({ items }) {
  ...
  return (
    <div className={'wrapper ' + styles.wrapper}>
      <Grid item md={12} className={'uppr-section-title ' + styles.upprSectionTitle}>
      ...
      <Grid item md={12} className={'uppr-section-content ' + styles.upprSectionContent}>
          ...
          return (
            ...
            >
              ...
              <Grid item xs={10} className="title">
                <a href={`${article.downloadLink}`}>{article.caption}</a>
              </Grid>
            </Grid>
          );
        })}
