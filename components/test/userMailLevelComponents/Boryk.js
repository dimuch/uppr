...
export default function Boryk() {
  return (
    <div className={styles.testResultMessage}>
      <p>
        Not bad, not bad at all. But there are no limits to perfection:).
      </p>
      <p>
        Here are the 5 habits you need to change to become a really effective emailer.
      </p>
      ...
      <p>
        ...
        Everyone is interested in themselves and cares about their goals and dreams. Your readers, as well.
      </p>
      <p>
        So shift your focus. Write so that the reader
      </p>
      <ol>
        <li>understands you well;</li>
        <li>feels important for you.</li>
      </ol>
      <p>
        These two points are a guarantee that your emails will be replied to.
      </p>
      ...
      <p>
        Many people overuse formal style; they think they will sound more competent and professional if they use more
        sophisticated words and construction. But no, they will just overload the reader and complicate what was born to
        be simple.
      </p>
      <p>
