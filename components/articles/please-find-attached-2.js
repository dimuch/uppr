...
const MEDIUM_LINK = `https://medium.com/@ivanka.tabachuk/the-world-is-larger-than-please-find-attached-5fa704e47262?postPublishedType=repub`;
...
export default function PleaseFindAttached2({ articleData }) {
    ...
    <div className={styles.article}>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>Альтернативи</h2>
 ...
 color: `#${articleData.article_color}` 
      ...
      <div className={styles.articleEvenSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>Чим коротше, тим краще</h2>
          ...
          <p className={styles.articleText}>
            UX більшості поштових клієнтів передбачає, що ви з легкістю, без зайвих слів помітите вкладення. А ще, якщо
          ...
          <p className={styles.articleText}>або просто</p>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          ...
          <p className={styles.articleText}>
            Ще один чудовий варіант, який тонко демонструє вашу націленість на співпрацю та побудову партнерських
            відносин.
          </p>
      ...
      <div className={styles.articleEvenSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          ...
          <p className={styles.articleText}>
            Якщо жоден з попередніх не підходить і є занепокоєння, що ваше вкладення не помітять, особливо у випадку
            довгого імейлу, напишіть <i>&quot;You&apos;ll find the attachment below.&quot;</i>.
          </p>
          ...
          <p className={styles.articleText}>
            Так, Ви правильно прочитали. Якщо ціль вашого імейлу просто надіслати вкладення – надішліть без зайвих
            пояснень. І це не є неввічливість у певних випадках.
          </p>
          <p className={styles.articleText}>
            Наприклад, ситуація: ви надсилаєте колезі вкладення у .docx форматі. Але він у відрядженні і зі смартфону
            зручніше читати .pdf, тому просить вас надіслати переформатований файл. Абсолютно нормально просто
            переслати, дублювати текст попереднього листа немає сенсу, а писати щось типу{' '}
            <i>&quot;Hope this will be more comfortable for you&quot;</i> – може прозвучати саркастично.
          </p>
