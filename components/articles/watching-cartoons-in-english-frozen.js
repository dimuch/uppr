        ...
        <div className={styles.article}>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={styles.articleText}>
                        Насправді, я дуже довго думала, кого ж все таки поставити на перше місце - Ріо чи Крижане Серце,
                        адже
                        мультфільми однаково класно зроблені та мега корисні для поповнення словника англійської. І Ріо
                        виграв
                        лише, як би не парадоксально це звучало, більшою позитивністю негативних героїв.
                        Але серед усіх мульт-сюжетів останніх років - цей для мене виявився не тривіальним та з досить
                        непередбачуваною кінцівкою;).
                    </p>
                </div>
            </div>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={styles.articleText}>
                        Якщо коротко, то мультфільм про те, як хоробра Анна вирушає в подорож,щоб звільнити своє
                        королівство від кайданів льоду сестри Ельзи та власне знайти її саму. Супутниками у цій пригоді
                    ...
                    <p className={styles.articleText}>
                        Саме Олаф,як на мене, є найбільш вдалим персонажем, який розтопить не одне крижане серце своїм
                        позитивом
                        та фразою&nbsp;<b><i>Some people are worth melting for.</i></b>
                    </p>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <p className={styles.articleText}>
                        Крім того, він говорить просто чудовою англійською, а зустріч Олафа з Анною та Крістофом, мабуть
                        одна з
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        <a href="https://drive.google.com/file/d/0B_HdrUABlRZodFFJT3BPTHMyMDg/view" target="_blank"
                           rel="noreferrer">
                    ...
                    <p className={styles.articleText}>
                        ...
                        часу переглянути увесь мультфільм - це для вас.
                    </p>
            ...
            <div className={styles.articleEvenSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={styles.articleText}>
                        ...
                        <br/>
                        <br/>
                        <b>Anna:</b> No! Why? <u>Why do you shut me out</u> (виключити, відгородитися, віддалитися, не
                        впускати)? Why do you shut the world out? What are you so afraid of?
                        <br/>
                        <br/>
                        <b>Anna:</b> I got engaged, but then <u>she freaked out</u> (була приголомшена/шокована) because
                        I&apos;d only just met him, you know that day. She said she wouldn&apos;t bless the marriage and…
                        <br/>
                        <br/>
                        <b>Kristoff:</b> [Interrupts] <u>Hang on</u> (постривай/зажди), you mean to tell me you got
                        engaged to someone you just met that day?
                        <br/>
                        <br/>
                        <b>Olaf:</b> I guess I was wrong. I guess Kristoff doesn&apos;t love you enough <u>to leave you
                        behind</u> (залишити).
                    </p>
                </div>
            </div>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={styles.articleText}>
                        ...
                        <br/>
                        <b>Hans:</b> <i>[Closing the curtains]</i> As thirteenth in line in my own kingdom, <u>I didn&apos;t
                        stand a chance</u> (не мати шансу, stand a chance - мати хороші шанси - можна використати,
                        говорячи і про нову посаду/роботу, і про робочі чи особисті відносини). <i>I knew, I&apos;d have to
                        marry into the throne somewhere.</i>
                        <br/>
                        <b>Anna:</b> What-what are you talking about?
                        <br/>
                        <b>Hans:</b> <i>[puts out a candle]</i> As heir, Elsa was preferable, of course, but <u>no one
                        was getting anywhere with</u> (добитися успіху - практично взаємозамінне зі словом success)
                        her. <u>But you</u> (лише ти).
                        <br/>
                        <b>Anna:</b> Hans?
                        <br/>
                        <b>Hans:</b> You were so desperate for love, you were willing to marry me,<u>just like
                        that!</u> (запросто, неждано-негадано, на рівному місці)
                        <br/>
                        ...
                        <br/>
                        <i>[He pours water onto the fire, putting it out. Anna reaches out to stop him, but collapses
                            onto the floor]</i>
                        <br/>
                        <b>Anna:</b> Hans, no! Stop!<b>Hans:</b> But then she doomed herself,
                        and <u>you were dumb</u> (тупий - може згодитися де завгодно) enough to go
                        after her.
                        <br/>
                        <b>Anna:</b> Please.
                        <br/>
                        ...
                        <br/>
                        <b>Anna:</b> <i>[bravely]</i> <u>You&apos;re no match for</u> (і близько не стояти, не рівня -
                        вживається для
                        порівняння людей,ідей, речей) Elsa.
                        <br/>
            ...
            <div className={styles.articleEvenSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <h3 className={`${styles.articlePhrase}`}
                        style={{color: `#${articleData.article_color}`}}
                    >
                        Не зважаючи на серйозність попереднього діалогу, в мультику є також дуже багато різних
                        &quot;підколок&quot;.
                    </h3>
                </div>
            </div>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <p className={styles.articleText}>
                        ...
                        <br/>
                        <b>Kristoff:</b> [to Anna, who put her feet on his sled] Whoa, whoa, whoa, put your feet down.
                        This is fresh lacquer. Seriously, <u>were you raised in a barn?</u>(Ти де виховувалася?)
                        <br/>
            ...
            <div className={styles.articleEvenSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <h3 className={`${styles.articlePhrase}`}
                        style={{color: `#${articleData.article_color}`}}
                    >
                        Шедевром також є і саундтрек до мультфільму, кіно версія якого виконана <u><a
                        href="https://en.wikipedia.org/wiki/Idina_Menzel" target="_blank" rel="noreferrer">
                        Ідіною Мензел.</a></u> Пісня отримала премію<b>&quot;Оскар&quot;</b> за кращу пісню до фільму,
                        премію<b>&quot;Гремі&quot;</b>, кіно премію<b>&quot;Вибір критиків&quot;</b>, і була номінована на<b>&quot;Золотий
                        глобус&quot;</b>. Вражає, правда?
                    </h3>
                </div>
            </div>
            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        <br/>
                        <a href="https://drive.google.com/file/d/0B_HdrUABlRZob0F1a3NZeWhEams/view" target="_blank"
                           rel="noreferrer">
                            Посилання на завдання
                        </a>
                    </p>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        <br/>
                        <a href="https://drive.google.com/file/d/0B_HdrUABlRZoRTBpZFdZTFNWVTg/view" target="_blank"
                           rel="noreferrer">
                            Посилання на завдання
                        </a>
                    </p>
