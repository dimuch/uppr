            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        emails</i></a> розібрали. Поглянемо, як все-таки варто починати професійний фолоап. Тобто, коли ви
                        нікого ні в що носом не тикаєте, не натякаєте, не агресуєте, не робите і не почуваєте всього
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        нагадувати(це один з найпоширеніших різновидів фолоапу, але не єдиний), то це означає, що вас
                        проігнорували(будемо називати речі своїми іменами) з тієї чи іншої причини, і вам доводиться
                        писати вдруге. Тож ви потрапляєте у більш залежну позицію, бо виказуєте свою вищу
                        зацікавленість, ніж в адресата. Виходить, що вам більше треба, ніж йому, і це вже дратує. Плюс
                        виконуєте подвійну роботу, це дратує у квадраті.
                    </p>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        продекларував ось це легендарне &quot;ми вам перетелефонуємо за тиждень&quot;. І вже другий закінчується,
                        а віз і нині там. Ви вирішуєте профолоапити й запитати, що там і як там? Написали один раз —
                        тиша.
                    </p>
            ...
            <div className={styles.articleEvenSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        імейл в спам потрапив&quot;. І без вмочань типу &quot;пишу, бо не отримав відповіді на попередній імейл&quot; і
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        дедлайн. Так, неодмінно вкажіть, на коли потрібна відповідь. Повірте <i>&quot;I need your input on Х
                        by [date/time]&quot;</i> не заслужить вам репутацію <i>pushy and bossy</i>, а от від невиконаної
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        більшості випадків). Але що вдіяти, після бою...
                    </p>
                    ...
                    <ul className={`${styles.articleList}`}>
                        ...
                        <li className={`${styles.discList}`}>
                            <p className={`${styles.articleText} ${styles.articleLink}`}>
                                Завершіть чітким та зрозумілим <i>call to action</i>.
                            </p>
                        </li>
                        <li className={`${styles.discList}`}>
                            <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        <li className={`${styles.discList}`}>
                            <p className={`${styles.articleText} ${styles.articleLink}`}>
                                І структуруйте імейл так, щоб вам було легко відповісти. Наприклад, просто &quot;так&quot; чи
                                &quot;ні&quot;.
                            </p>
                        </li>
                    </ul>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        Дійсно один з найкращих способів уникнути подальших фолоапів — це обговорити всі очікування від
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        реагуєте.
                        І коли вам щось дійсно потрібно терміново, і це робочий момент, то абсолютно нормально прямо і
                    ...
                    <ul className={`${styles.articleList}`}>
                        ...
                        <li className={`${styles.discList}`}>
                            <p className={`${styles.articleText} ${styles.articleLink}`}>
                                ...
                                одразу кинуться вам відповідати, аби тільки ви не дзвонили і не виносили мозок
                                телефоном).
                            </p>
                        </li>
                    </ul>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        пояснити у телефонній розмові і прийняти рішення набагато швидше, ніж в імейлінгу. Звісно, не
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        Але навіть якщо ви таки поговорили і розв&apos;язали питання телефоном, однаково напишіть фолоап щодо
                        вашої
                        бесіди, щоб зафіксувати рішення та <i>make it official</i>.
                    </p>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        Від ефективних фолоапів, насправді, виграють усі. Якщо і не одразу, то у довгостроковій
                        перспективі точно. Тому немає сенсу накручувати себе та впадати у контрпродуктивне
