            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                  <p className={`${styles.articleText} ${styles.articleLink}`}>
                    ...
                    тривимірних граматичних конструкцій та не використають ось це &quot;фейспалмне&quot;
                    <i>herewith</i> і
                    ...
                    відповісти &quot;так&quot; або &quot;ні&quot; — повага до часу та зусиль інших. Пам&apos;ятайте,
                    найкраще закінчення
                  ...
                  <p className={`${styles.articleText} ${styles.articleLink}`}>
                    ...
                    простим копіпейстом не обійдешся. Потрібно напружитися, подумати,
                    підібрати &quot;правильні&quot; слова, а
