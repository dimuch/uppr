    ...
    <div className={styles.article}>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          ...
          <h2 className={styles.subTitle}>Якщо можна написати імейл — напишіть його!</h2>

          <p className={styles.articleText}>
            Звісно, <i>face-to face</i> зустрічі — важливі, але коли можна написати імейл і заощадити (і час, і гроші) —
            напишіть його.
          </p>
          ...
          <div className={styles.frameWithExampleAndTitle}>
            ...
            <p className={`${styles.articleText}  ${styles.exampleText}`}>
              Hello Team,
              <br />
              This week&apos;s [project] catch-up meeting is being cancelled since everything is on track and everybody
              is aligned on the next steps.
              <br />
              <br />
          ...
          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Ще одна досить типова ситуація з мітингами, коли о 13:00 колега запитує чи ви можете взяти участь у зустрічі
            о 14:30.
          </p>

          <p className={`${styles.articleText} ${styles.articleLink}`}>Чудово, чи не так?</p>
        </div>
      </div>

      <div className={styles.articleEvenSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>Відмовляйте екологічно</h2>

          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Мало того, що день уже давно розписаний пріоритетними завданнями і дедлайни &quot;піджимають&quot;, так ще й
            підготуватися потрібно, уже не кажучи про таку прикрість, як обід.
          </p>

          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Плюс тім-плеєром залишитися теж хочеться, тим паче, що 360 degrees appraisal та salary review на носі, але
            до кінця року купа дедлайнів.
          </p>

          <p className={styles.articleText}>Одним словом мозок починає прискорено шукати шляхи виходу з халепи.</p>

          <p className={styles.articleText}>
            Тому, якщо ви, звісно, не деклайните кожен мітинг і ні на що не підписувалися заздалегідь, у вас є повне
            право відмовити.
          </p>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>Ок, а якщо потрібно написати імейл-відмову від зустрічі САМОМУ Клієнту?</h2>
          ...
          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Звісно, всі вже проактивні імейлери й знають, що просто так щось забрати, не давши нічого натомість
            неможливо. Особливо, якщо ми хочемо, щоб клієнт ще довго приносив гроші компанії і нам.
          </p>

          <p className={`${styles.articleText} ${styles.articleLink}`}>Що в такій ситуації можна запропонувати?</p>
          <ul className={`${styles.articleList}`}>
            <li className={`${styles.numberedList}`}>
              <p className={`${styles.articleText} ${styles.articleLink}`}>
          ...
          <div className={styles.frameWithExampleAndTitle}>
            ...
            <p className={`${styles.articleText}  ${styles.exampleText}`}>
              ...
              <br />
              <br />
              Thanks for getting back to me with [issue]. I&apos;m on a business trip this week and cannot devote enough
              time the discussion of the [issues] deserves.
              <br />
          ...
          <div className={styles.frameWithExampleAndTitle}>
            ...
            <p className={`${styles.articleText}  ${styles.exampleText}`}>
              ...
              <br />
              <br />
              I&apos;m in the US this week and due to time difference can discuss [issues] neither in person nor by
              phone.
              <br />
              ...
              <br />
              <br />
              If you&apos;d prefer to discuss in person, I&apos;m available on [date] and would be happy to talk more
              about it then.
              <br />
              <br />
              Thanks.
