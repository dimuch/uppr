        ...
        <div className={styles.article}>
                ...
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <div className={styles.frameWithExampleAndTitle}
                        ...
                        <p className={`${styles.articleText}  ${styles.exampleText}`}>
                            ...
                            I also want to express my sincere gratitude for the opportunity you&apos;ve provided me with by
                            entrusting the responsibilities of the project manager in your team. I want to ensure you
                            that I will put all
                            possible
                            efforts to bring the maximum contribution to the project.
                            Therefore, to start immediately I require the names and email addresses of the team members.
                            Can
                            you possibly
                            share them with me? Can I also ask you to introduce me to the team?
                            <br/>
                            <br/>
            ...
            <div className={styles.articleEvenSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={styles.articleText}>
                        Як я уже казала, лист вийшов дуже олдскульним. І як писали в коментарях на FB, ніби взятий з
                        підручника по
                        листуванню 20-річної давності. Тобто, в ньому все правильно, граматично і стилістично, але
                        &quot;живі&quot; люди так уже
                        не пишуть;)). Скоріше, боти якісь або ті, кому ліньки думати і легше не напружуватися та
                        скопіпейстити кліше з
                        підручника.
                    </p>

                    <p className={styles.articleText}>
                        Хоч у випадку з ПМом (автором листа), основну роль відіграла боязнь прозвучати неввічливим та не
                        дотриматися
                        бізнес- етикету з нейтівом (босом). Але давайте психологію залишимо професіоналам, а самі,
                        все-таки, перейдемо
                        до конкретних фейлів у листі:
                    </p>
                    ...
                    <ol className={`${styles.articleList} ${styles.numberedList} ${styles.articleLink}`}>
                        ...
                        <li>
                            <p className={styles.articleText}>
                                ...
                                contacts.</b></i> - теж відносно ОК. Але все-таки початок типу <i><b>send me, give me, bring me</b></i> - не
                                найкращий, тому що
                ...
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <div className={styles.frameWithExampleAndTitle}
                        ...
                        <p className={`${styles.articleText}  ${styles.exampleText}`}>
                            ...
                            <br/>
                            <br/>
                            To promptly dive into work, can you, please, share with me the team’s emails, as
                            well as make a short
                            introduction?
                            <br/>
                            I also attach my working plan for the next two weeks, as I see it. Do
                            have any thoughts/comments on it?
                            <br/>
                            <br/>
                            Thanks in advance.
                        </p>
