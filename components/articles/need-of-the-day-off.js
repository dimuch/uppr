...
export default function NeedOfTheDayOff({ articleData }) {
    ...
    <div className={styles.article}>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          ...
          <p className={styles.articleText}>
            Найперше і найголовніше - менеджера не інформують і не ставлять до відома (звісно, якщо це не імейл про
            звільнення і то, в таки випадках є своя більш коректна процедура). І навіть, якщо ви з менеджером на “ти” і
            п&apos;єте з ним пиво кожної п&apos;ятниці, все одно - це діловий імейл і має бути певна субординація.
          </p>

          <p className={styles.articleText}>
            А <i>“Please confirm.”</i> – це наказовий спосіб і в проханнях не прийнято використовувати таку форму. Краще
            використати <i>“can you/ could you.”</i>
          </p>
        </div>
      </div>
      ...
      <div className={styles.articleEvenSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>Якщо потрібен day off</h2>
 ...
 color: `#${articleData.article_color}` 
          ...
          >
            <li>
              <p className={styles.articleText}>
                Повідомляйте про бажання взяти day off заздалегідь. Ні, тиждень перед власне бажаною датою - це не
                заздалегідь! Звісно, в житті трапляється багато несподіванок і може статися так, що вихідний вам
                потрібен уже завтра. І це нормально. Але, наприклад, якщо берете day off заради весілля ліпшого друга,
 ...
 color: `#${articleData.article_color}` 
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <h2 className={styles.subTitle}>А тепер про шаблони</h2>
        </div>
      </div>
      ...
      <div className={styles.articleOddSection}>
        <div className={styles.maxWidthArticleSectionWrapper}>
          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Універсальний шаблон важко скласти - дуже все залежить від контексту та ваших відносин з командою і
            менеджером. Але поділюся з вами найкращим з того, що мені доводилося отримувати чи писати.
          </p>
 ...
 color: `#${articleData.article_color}` 
          ...
          >
            <li>
              <p className={styles.articleText}>
                I’d much appreciate it, if you approve my day-off on 23 August, I badly need it (due to some personal
                reasons).
              </p>
            </li>
            <li style={{
 ...
 color: `#${articleData.article_color}` 
          ...
          <h3 className={styles.articleSubSubTitle}>Про статус та заміни на проекті</h3>
 ...
 color: `#${articleData.article_color}` 
          ...
          >
            <li>
              <p className={styles.articleText}>
                I am a few days ahead on the new promotional video, so there is no issue about falling behind on the
                project.
              </p>
            </li>
            <li style={{
 ...
 color: `#${articleData.article_color}` 
          ...
          <p className={`${styles.articleText} ${styles.articleLink}`}>
            Складання імейлу про day off не повинно стати стресом ні для вас, ні для вашого боса. Навпаки, трохи
            планування та обдумування, такту та проактивності, і ви без затримок відправитеся у заслужений і такий
