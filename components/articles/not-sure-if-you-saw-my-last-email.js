            ...
            <div className={styles.articleOddSection}>
                <div className={styles.maxWidthArticleSectionWrapper}>
                    ...
                    <p className={`${styles.articleText} ${styles.articleLink}`}>
                        ...
                        href="/blog/articles/stupid-emails-introductions" target="_blank" rel="noreferrer">уже
                        писала</a>.
                    </p>
                    ...
                    <p className={styles.articleText}>
                        Ось усі ці <i>&quot;just checking in</i>— варіації благання &quot;Не ігнорте мене, якщо ваша ласка, зверніть увагу!&quot;
                    </p>
